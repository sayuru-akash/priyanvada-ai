        ...
        <div className="w-full max-w-2xl">
          ...
          >
            <div className="relative">
              <textarea
                rows={3}
                placeholder="Start typing to begin a new chat..."
                value={inputMessage}
                onChange={(e) => setInputMessage(e.target.value)}
                onKeyPress={handleKeyPress}
                disabled={loading}
                className="w-full px-6 py-4 pr-16 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 bg-white shadow-lg resize-none"
              />
              <button
                type="submit"
