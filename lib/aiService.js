...
<<<<<<< HEAD
    // Use gemini-2.5-flash-lite for images, gemini-2.5-pro for text
...
>>>>>>> 8ec78c849eb7010772b86e2189dd214281b19498
...
Remember: You are ${
  ...
  async generateCharacterResponse(
    ...
    // Use gemini-2.5-flash-lite for images, gemini-2.5-pro for text
    const modelName = hasImages ? "gemini-2.5-flash-lite" : "gemini-2.5-pro";
    console.log(`Character response using model: ${modelName}`);
