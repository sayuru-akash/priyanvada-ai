    ...
    for (let attempt = 0; attempt < maxRetries; attempt++) {
      try {
        ...
        if (modelName === "gemini-2.5-flash-lite-preview-09-2025") {
          lengthInstruction =
            " IMPORTANT: Provide detailed, comprehensive responses with at least 200 tokens. Elaborate on your answers, include examples, explanations, and context to ensure richness and depth in your response.";
        }
...
Remember: You are ${
      character.name
    }. Respond naturally as this character would, using the SAME LANGUAGE as the user.${lengthInstruction}`;
