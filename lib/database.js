...
class DatabaseService {
  ...
  async updateCharacter(characterId, updates) {
    ...
    if (updates.personality !== undefined) fields.personality = updates.personality;
    if (updates.scenario !== undefined) fields.scenario = updates.scenario;
    if (updates.greeting !== undefined) fields.greeting = updates.greeting;
    if (updates.exampleMessages !== undefined)
      fields.example_messages = updates.exampleMessages;
    if (updates.tags !== undefined) fields.tags = updates.tags;
    if (updates.avatarUrl !== undefined) fields.avatar_url = updates.avatarUrl;
    if (updates.isPublic !== undefined) fields.is_public = updates.isPublic;
