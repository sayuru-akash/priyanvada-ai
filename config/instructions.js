export const instructionsConfig = {
  systemInstructions: {
    default: {
      ...
      context:
        "You are an AI assistant designed to help users with various tasks and questions.",
    },
    coding: {
      ...
      context:
        "You are an expert software developer helping with coding tasks, debugging, and technical guidance.",
    },
    creative: {
      ...
      context:
        "You are a creative assistant helping with writing, brainstorming, and artistic endeavors.",
    },
  },
  chatSettings: {
    maxTokens: 8192,
